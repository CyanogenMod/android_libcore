...
static JNINativeMethod gMethods[] = {
    NATIVE_METHOD(OSMemory, flushImpl, "(IJ)I"),
    ...
    NATIVE_METHOD(OSMemory, isLittleEndianImpl, "()Z"),
    NATIVE_METHOD(OSMemory, isLoadedImpl, "(IJ)Z"),
    NATIVE_METHOD(OSMemory, loadImpl, "(IJ)I"),
    ...
    NATIVE_METHOD(OSMemory, unmapImpl, "(IJ)V"),
};
